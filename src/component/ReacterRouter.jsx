...
const ReacterRouter = () => {
  return (
    <div>
        <Routes>
        <Route path='/' element={<Outlet></Outlet>}>{/* index on a Route, it means that this route will be rendered when the parent route's path is matched exactly. */}
        <Route index element={<div>Home Page</div>}></Route>
         ...
         <Route path='reset-password' element={<AdminResetPassword/>}></Route>
          ...
          <Route path='admin' element={<Outlet/>}>
            ...
            <Route path='update-password' element={<AdminPasswordUpdate/>}></Route> 
            <Route path='forgot-password' element={<AdminForgetPassword/>}></Route>
